...
public class DataWorksOpenApiClient {
    ...
    public IAcsClient createClient(){
        IClientProfile profile = DefaultProfile.getProfile(apiParamProperties.getRegionId(),
                apiParamProperties.getAccessKeyId(), apiParamProperties.getAccessKeySecret());
        if(apiParamProperties.isVpcEnv()){
            DefaultProfile.addEndpoint(apiParamProperties.getRegionId(),
                    apiParamProperties.getProduct(), apiParamProperties.getEndpoint());
        }
